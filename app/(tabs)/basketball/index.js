...
import { View, Text, FlatList, Image, StyleSheet, TouchableOpacity, ScrollView, SafeAreaView, useColorScheme } from "react-native";
...
export default function Basketball() {
    ...
    const renderLiveStreams = () => (
        <>
            <Text style={styles.headerText}>Basketbola tiešraides tev</Text>
    ...
    const renderListHeader = () => (
        <View style={styles.listHeader}>
            {renderLiveStreams()}
            <Text style={styles.headerText}>Basketbola ziņas</Text>
        </View>
    );
